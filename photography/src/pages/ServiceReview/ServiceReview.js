...
const ServiceReview = ({showReview}) => {
    ...
    return (
        <div className="container flex flex-col mt-10 w-full max-w-lg p-6 mx-auto divide-y rounded-md shadow-md divide-gray-900 dark:bg-gray-900 dark:text-gray-100">
